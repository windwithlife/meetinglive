...
export default class HomePage extends React.Component {
    ...
    Store = () => {
        return this.props.recommendDetailStore;
    }
    StoreData = () => {
        return this.props.recommendDetailStore.dataObject;
    }
    ...
    handleLineUpdate(index, record) {
        let path ="/generic/recommendDetail_edit";
        router.push({ pathname: path, query: { id: record.id } });

    }
    handleLineDetail(record) {
        let path ="/generic/recommendDetail_detail";
        console.log(path);
        router.push({ pathname: path, query: { id: record.id } });
    }
    handleLineAdd() {
        let path ="/generic/recommendDetail_add";
